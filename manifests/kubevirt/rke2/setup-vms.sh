...
for server in "${SERVERS[@]}"; do
    virtctl image-upload pvc ${server}-boot --size 50G --insecure --image-path=/home/ccrow/Downloads/noble-server-cloudimg-amd64.img --uploadproxy-url=https://localhost:8080
    sleep 5
